            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className={`px-2 py-1 text-xs border rounded focus:outline-none focus:ring-1 focus:ring-blue-500 w-32 ${
                  !broadcastTitleVariables[0].value ? 'border-red-400 bg-red-50 placeholder-red-300' : 'border-gray-300 bg-white'
                }`}
      ...
      <div className="flex items-center gap-2 mb-3 bg-white p-1 rounded-md border border-gray-300 w-fit shadow-sm">
        <button
          ...
          className={`px-3 py-1.5 text-xs font-medium rounded transition-colors ${
            headerMediaSource === 'upload' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'
          }`}
        >
          Upload File
        </button>
        <button
          ...
          className={`px-3 py-1.5 text-xs font-medium rounded transition-colors ${
            headerMediaSource === 'link' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'
          }`}
        >
          Paste Link
        </button>
        ...
        {bodyVariables.map((v, i) => (
          <div key={i} className="flex items-center gap-2 px-2 py-1 bg-white border border-gray-200 rounded shadow-sm text-[11px]">
            ...
            <input
              ...
              className={`px-1.5 py-0.5 text-[11px] border rounded focus:outline-none focus:ring-1 focus:ring-blue-500 w-24 ${
                !v.value ? 'border-red-400 bg-red-50 placeholder-red-300' : 'border-gray-200 bg-white'
              }`}
              placeholder="Sample..."
            />
            <button
