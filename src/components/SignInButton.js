...
function SignInButton() {
  ...
  return (
    <button 
      ...
      className="px-4 py-2 bg-blue-600 text-white rounded disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors"
    >
      ...
      {isGoogleSigningIn ? 'Signing in...' : 'Sign In / Sign Up'}
    </button>
  );
}
